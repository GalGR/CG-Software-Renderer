...
template <typename V>
static inline Point to_screen_coords(const V &v, const Screen &screen) {
	return Point{
...
template <typename V>
static inline std::array<double, 2> to_screen_coords_double(const V &v, const Screen &screen) {
...
static inline Vector4 to_view_coords(const Point &p, const Screen &screen) {
	return Vector4{
