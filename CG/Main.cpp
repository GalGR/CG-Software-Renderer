...
enum DefaultKeybind {
	...
	DEFAULT_CAM_UP = ' ',
	DEFAULT_CAM_DOWN = ModifierKey::SHIFT,
	...
	DEFAULT_OBJ_ALT_MOVE = ModifierKey::ALT,
	DEFAULT_ESCAPE_ALL = 27, // Escape ASCII code
	DEFAULT_OBJ_CONTROL_MODEL = ModifierKey::CTRL,
};
...
// Screen dimensions
Screen screen = { START_WIDTH, START_HEIGHT };
...
void Timer(int value) {
	...
	if (frame_number == value) { // No frame was rendered at that time frame
